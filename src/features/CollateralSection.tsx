...
export default function CollateralSelection({
  onSelect,
}: CollateralSelectionProps): ReactElement {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  const [_collateral, setCollateral] = useState<COLLATERAL_TYPE>(
    COLLATERAL_TYPE.ETH
  )
  ...
  return (
    <div>
      ...
      <Select defaultValue={COLLATERAL_TYPE.ETH} onValueChange={handleChange}>
        ...
        <SelectContent>
          <SelectItem
            value={COLLATERAL_TYPE.ETH}
            className="border-b border-gray-300"
          >
            {COLLATERAL_TYPE.ETH}
          </SelectItem>
          <SelectItem
            value={COLLATERAL_TYPE.WBTC}
            className="border-b border-gray-300"
          >
            {COLLATERAL_TYPE.WBTC}
          </SelectItem>
          <SelectItem value={COLLATERAL_TYPE.USDC}>
